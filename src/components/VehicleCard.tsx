...
import { Star, MapPin, Users, Fuel, Settings, Heart, Zap, Gauge } from 'lucide-react';
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-gray-500 text-sm">({vehicle.reviewsCount})</span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 text-gray-400 text-sm">
                            ...
                            {vehicle.mileageLimit && (
                                <div className="flex items-center gap-1">
                                    <Gauge size={14} />
                                    <span>{vehicle.mileageLimit} км</span>
                                </div>
                            )}
                        </div>
                    </div>
