        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-4">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Присоединяйтесь к RentUA</p>
                </div>
                ...
                <div className="card-glass p-8">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white text-gray-900 rounded-lg font-medium hover:bg-gray-100 transition-colors mb-6"
                    >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                {formData.confirmPassword && formData.password === formData.confirmPassword && (
                                    <CheckCircle size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-green-400" />
                                )}
                            </div>
                        </div>
